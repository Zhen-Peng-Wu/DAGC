...
class AutoModel(object):
    ...
    def __init__(self, data, search_parameter, gnn_parameter, args):
        ...
        scaffold_data = [data, train_dataset, valid_dataset, test_dataset, train_loader, valid_loader, test_loader]

        self.data = scaffold_data
    ...
    def derive_target_model(self):
        ...
        architecture_performance_list = self.gnn_architecture_performance_load(path, self.gnn_parameter['data_name'])

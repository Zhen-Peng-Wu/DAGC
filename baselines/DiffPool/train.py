...
def benchmark_task_val(args, writer=None, feat='node-label'):
    ...
    all_vals_mean = round(np.mean(all_vals, axis=0)[0]*100, 2)
    all_vals_std = round(np.std(all_vals, axis=0)[0]*100, 2)
    print('final acc:{}±{}'.format(all_vals_mean,all_vals_std))
...
if __name__ == "__main__":
    ## the example of run command: python train.py --bmname DD --cuda 0
    main()

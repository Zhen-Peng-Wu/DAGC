...
## the example of run command: python main.py --baseline_name GCNConv --data_name COX2
def arg_parse():
    ...
    parser.add_argument('--data_name', type=str, default='DD', help='location of the data corpus')

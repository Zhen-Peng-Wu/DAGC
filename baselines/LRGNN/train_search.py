...
# python train_search.py --data COX2  --gpu 0 --num_blocks 8 --cell_mode full --num_cells 1 --agg gcn --cos_temp --BN
parser = argparse.ArgumentParser("")
parser.add_argument('--data', type=str, default='COX2', help='dataset name')

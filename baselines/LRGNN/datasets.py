...
def load_tudata(dataset_name='DD', cleaned=False, split_seed=12345, batch_size=32, remove_large_graph=True, folds=20):
    ...
    if folds == 20:
        ...
        split = [cat(idx[:18], 0), cat(idx[18:19], 0), cat(idx[19:], 0)]
    elif folds == 5:
...
def load_data(dataset_name='DD', cleaned=False, split_seed=12345, batch_size=32, remove_large_graph=True, folds=20):

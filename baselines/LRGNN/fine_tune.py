...
# python fine_tune.py --data COX2 --gpu 0 --num_blocks 8 --num_cells 1 --cell_mode full   --arch_filename exp_res/COX2-searched.txt   --cos_lr --BN --hyper_epoch 20
def get_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--gpu', type=int, default=0, help='gpu device id')
    parser.add_argument('--data', type=str, default='COX2', help='location of the data corpus')

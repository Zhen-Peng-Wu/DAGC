...
parser.add_argument('--data', type=str, default='IMDB-BINARY')
...
NCI1_B12C1_full_params = {'gpu': 2, 'data': 'NCI1', 'arch_filename': 'exp_res/NCI1-searched-20220620-202058.txt', 
               ...
               'hidden_size': 512, 'learning_rate': 0.008814121411828977, 'weight_decay': 0.0, 'ft_mode': 'kfold', 'BN': True, 
...
NCI109_B8C1_full_params = {'gpu': 7, 'data': 'NCI109', 'arch_filename': '', 
                           ...
                           'num_blocks': 8, 'num_cells': 1, 'cell_mode': 'full', 'ft_mode': 'kfold', 'BN': True, 'LN':False, 'rml2': True, 
...
DD_B12C1_full_params = {'gpu': 4, 'data': 'DD', 'arch_filename': '', 
                        ...
                        'num_blocks': 12, 'num_cells': 1, 'cell_mode': 'full', 'agg': 'gcn', 'search_agg': False, 'model_type': 'NONE',
                          ...
                          'ft_mode': 'kfold', 'BN': True, 'LN': False, 'rml2': False, 'rmdropout': False, 'hyper_epoch': 20, 
...
PROTEINS_B8C1_full_params = {'gpu': 2, 'data': 'PROTEINS', 'arch_filename': '', 
                             ...
                             'num_blocks': 8, 'num_cells': 1, 'cell_mode': 'full', 'ft_mode': 'kfold', 'BN': True, 'LN': False, 'rml2': False, 
